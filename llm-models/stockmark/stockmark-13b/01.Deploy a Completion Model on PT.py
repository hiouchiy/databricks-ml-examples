...
HF_REPO_ID = "stockmark/stockmark-13b-instruct"

MODEL_PATH = "/Volumes/hiroshi/models/models_from_hf/stockmark-13b-instruct"

# for UC
catalog = "hiroshi"
schema = "models"
model_name = "stockmark-13b-instruct-completion"
registered_model_name = f"{catalog}.{schema}.{model_name}"

# Endpoint name
endpoint_name = f'hiroshi-{model_name}'
...
tokenizer = AutoTokenizer.from_pretrained(MODEL_PATH, chat_template=None)
...
with mlflow.start_run(run_name="stockmark-13b-instruct") as run:
